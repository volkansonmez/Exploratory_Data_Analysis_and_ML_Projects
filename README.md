...
### Framingham dataset is analyzed with Pandas, Seaborn, and Matplot Libraries.
### KNN, Logistic Regression, and a One Layer Neural Network are applied to the dataset.
